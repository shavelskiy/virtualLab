      ...
      <form class="form-horizontal">
        <div class="form-row">
          ...
          <div class="form-group col-6">
            <label class="radio-inline"><input type="radio" v-model="mode" class="gdm-mode" value="v" name="mode"
                                               checked>V</label>
            <label class="radio-inline"><input type="radio" v-model="mode" class="gdm-mode" value="a"
                                               name="mode">mA</label>
            <label class="radio-inline"><input type="radio" v-model="mode" class="gdm-mode" value="o"
                                               name="mode">kΩ</label>
          </div>
