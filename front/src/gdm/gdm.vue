            ...
            <form class="form-horizontal">
                <div class="form-row">
                    ...
                    <div class="form-group col-6">
                        <label class="radio-inline"><input type="radio" v-model="mode" class="gdm-mode" value="u"
                                                           name="mode" checked>V</label>
                        <label class="radio-inline"><input type="radio" v-model="mode" class="gdm-mode" value="i"
                                                           name="mode">mA</label>
                        <label class="radio-inline"><input type="radio" v-model="mode" class="gdm-mode" value="r"
                                                           name="mode">kΩ</label>
                    </div>
