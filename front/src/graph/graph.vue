  ...
  export default {
    ...
    methods: {
      ...
      drawGrid: function () {
        ...
        this.context.fillText('U, В', this.canvas.width - 80, this.canvas.height - 30)
        this.context.fillText('5', this.canvas.width - 150, this.canvas.height - 28)
      ...
      drawGraph: function(data) {
        ...
        if (!this.errorCount && !this.errorType) {
          ...
          this.context.beginPath();
          this.context.moveTo(x0 + 100 * (data.data.volts[0]), y0 - 5 * data.data.ampers[0]);

          for (var i = 1; i < 13; i++) {
            this.context.lineTo(x0 + 100 * (data.data.volts[i]), y0 - 5 * data.data.ampers[i]);
          }
