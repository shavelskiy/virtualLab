...
class LabController extends Controller
{
    ...
    {
        $lab = new Lab();
        $lab->name = 'Простейшие компоненты электрических цепей';
        $lab->description = 'Ознакомление с измерительными приборами и стендом, изучение свойств реальных источников энергии и линейных компонентов электрической цепи при постоянных токах и напряжениях.';
        ...
        $lab->preview_picture = 'lab7_pre.png';
        $lab->save();

        $lab = new Lab();
        $lab->name = 'Переходные процессы в RLC цепях';
        $lab->description = 'Исследование переходных процессов в последовательной RLC цепи, нахождение переходной функции, анализ влияния параметров цепи на характер переходных процессов.';
        $lab->preview_picture = 'lab8_pre.png';
        $lab->save();
    }
}